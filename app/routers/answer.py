...
from app.routers.dependencies import UOWDep, CurrentUserDep, AnswerServiceDep
...
@router.get("/question/{question_id}/answers", response_model=List[AnswerSchemaResponse])
async def get_answers_by_question_id(
    ...
    return await service.get_answers_by_question_id(uow, question_id, current_user.id, skip, limit)
