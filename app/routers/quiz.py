...
from app.schemas.quiz import CreateQuizRequest, UpdateQuizRequest, QuizSchemaResponse, QuizzesListResponse, \
    QuizzesListResponse
from app.services.quiz import QuizService
from app.routers.dependencies import UOWDep, CurrentUserDep, QuizServiceDep
...
async def get_quizzes(
    ...
    return await service.get_quizzes(uow, company_id, skip, limit, current_user.id, str(request.url))
